                    ...
                    <div class="result">
                        <?php
                            ...
                            <div class="result__message">
                                ...
                                <p>Kết quả tìm kiếm cho từ khoá  <span>"<?php echo $_GET['search'] ?>"</span></p>
                        ...
                        <?php
                            ...
                            <div class="result__message">
                                ...
                                <p>Chúng tôi không tìm thấy sản phẩm  <span>"<?php echo $_GET['search'] ?>"</span> nào. Bên dưới là kết quả gợi ý thay thế.</p>               
                            </div>
                        <?php
                                }
                            }
                    ...
                    <div class="product">
                        <div class="row sm-gutter">
                            ...
                            <div class="col elg-2-4 lg-3 md-3 sm-4 exsm-6">
                                <a href="./ProductDetail/<?php echo $value['productId']; ?><?php if (isset($_GET['search'])) {
