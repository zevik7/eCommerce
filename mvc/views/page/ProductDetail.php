                            ...
                            <div class="amazingslider-wrapper" id="amazingslider-wrapper-1" style="display:block;position:relative;margin:0px auto 116px">
                                <div class="amazingslider" id="amazingslider-1" style="display:block;position:relative;margin:0 auto;">
                                    <ul class="amazingslider-slides" style="display:none;">
                                        <li>
                                            <img src="public/img/product/aokhoac.jpg" alt="aokhoac"  title="aokhoac" data-description="ao anh" />
                                        </li>
                                        <li>
                                            <img src="public/img/product/aosomi.jpg" alt="aosomi"  title="aosomi" data-description="day la mo ta so mi anh" />
                                        </li>
                                        <li>
                                            <img src="public/img/product/chongnang.png" alt="chongnang"  title="chongnang" data-description="ao chong nang anh" />
                                        </li>
                                        <li>
                                            <img src="public/img/product/1200px-Logo_Dai_hoc_Can_Tho.png" alt="cloud will beat"  title="cloud will beat" data-description="video" />
                                            <video preload="none" src="public/img/product/cloud%20will%20beat.mp4" ></video>
                                        </li>
                                        <li>
                                            <img src="public/img/product/cocsac.jpg" alt="cocsac"  title="cocsac" />
                                        </li>
                                    </ul>
                        ...
                        <div class="product-detail__content">
                            <div class="product-heading">
                                <span class="product-title">
                                    ...
                                    Laptop HP Pavilion Gaming 15-dk1086TX 206R3PA i7-10750H 8G 512G 1650Ti W10 Laptop HP Pavilion Gaming 15-dk1086TX 206R3PA i7-10750H 8G 512G 1650Ti W10 Laptop HP Pavilion Gaming 15-dk1086TX 206R3PA i7-10750H 8G 512G 1650Ti W10
                                </span> 
                            </div>
                            <div class="product-statis mt-20">
                                <div class="statis-item product-rating">
                                    <span class="product-rating__number">5.0</span>
                                ...
                                <div class="statis-item product-vote">
                                    <span class="product-vote__number">333</span>
                                    <span class="product-vote__icon">Đánh giá</span>
                                </div>  
                                
                                <div class="statis-item product-sold">
                                    <span class="product-sold__number">14</span>
                                    <span class="product-sold__icon">Đã bán</span>
                                </div>
                            </div>
                            <div class="product-price mt-10">
                                <span class="product-price__from">190.000 đ</span>
                                <span class="product-price__to">- 200.000 đ</span>
                            </div>
                            ...
                            <div class="product-type row mt-20">
                                ...
                                <div class="product-type__body col-9">
                                    <ul class="list-type">
                                        <li class="list-type__item btn btn-third active">Size 12</li>
                                        <li class="list-type__item btn btn-third">Size 11</li>
                                        <li class="list-type__item btn btn-third">Size 10</li>
                                        <li class="list-type__item btn btn-third">Size 10</li>
                                        <li class="list-type__item btn btn-third">Size 10</li>
                                        <li class="list-type__item btn btn-third">Size 10</li>
                                        <li class="list-type__item btn btn-third">Size 10</li>
                            ...
                            <div class="product-type row mt-20">
                                ...
                                <div class="product-type__body col-9">
                                    <ul class="list-type">
                                        <li class="list-type__item btn btn-third active">Trắng</li>
                                        <li class="list-type__item btn btn-third">Đen</li>
                                        <li class="list-type__item btn btn-third">Hồng</li>
                                    </ul>
                                </div>
                            </div>
