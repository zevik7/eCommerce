...
INSERT INTO `carts` VALUES (3,1,5,10,'2020-03-03 01:01:10'),(6,1,6,3,NULL);
...
INSERT INTO `order_details` VALUES (1,1,1,10,10000.00);
...
INSERT INTO `orders` VALUES (1,1,'0000-00-00 00:00:00','done');
...
INSERT INTO `product_categories` VALUES (1,'Thời trang',NULL),(2,'Giày',NULL),(3,'Đồ điện tử',NULL),(4,'Sách',NULL),(5,'Quà tặng',NULL),(6,'Mỹ phẩm',NULL);
...
INSERT INTO `product_ratings` VALUES (1,1,1,4,'Tạm ổn, chất lượng vải khá tốt nhưng may chưa được đẹp',NULL,NULL),(2,1,1,5,'Áo đẹp nha mụi ngừ !!!',NULL,NULL),(3,1,1,3,'Buồn nên cho 3 sao',NULL,NULL),(4,7,1,4,'ok',NULL,NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `product_rating_AFTER_INSERT` AFTER INSERT ON `product_ratings` FOR EACH ROW BEGIN
	set @product_type_id = NEW.product_type_id;
    set @newRatingStar = NEW.star;
    set @product_id = (
        SELECT product_id FROM product_types pt
        WHERE pt.id = @product_type_id
    );
	set @ratingStar = (select rating from products where id = @product_id);
	IF @ratingStar IS NULL THEN
			update products
				set rating = @newRatingStar
			where (id = @product_id);
	ELSE
			update products
				set rating = (select AVG(star) from product_ratings where product_id = @product_id)
			where (id = @product_id);
	END IF;
END */;;
DELIMITER ;
...
INSERT INTO `users` VALUES (1,2,'monnatyz@gmail.com','0898007389','12345678','hello','Hậu Giang'),(2,2,'phu@mgmail.com','0898007388','12312378','hello','Cần Thơ'),(5,2,'monnatyz@gmail.commm','0898007380','123123123','hello',NULL);
...
-- Dump completed on 2021-10-06 13:52:54
