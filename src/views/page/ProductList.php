        ...
        <div class="grid wide padding-top20">
            <div class="row"> 
                <div class="col lg-2 md-2 sm-0 exsm-0">
                    <?php require_once '../src/views/block/product-list/Category.php'?>
                </div>
                <div class="col lg-10 md-10 sm-12 exsm-12">
                    <div class="">
                        <?php require_once '../src/views/block/product-list/Filter.php'?>
                    </div>
                    <div class="result">
                        <?php
                            if (isset($_GET['search']) && $_GET['search'] != '') {
                                if ($_SESSION['search'] != 404) {
                                    ?>
                            <div class="result__message">
                                ...
                                <p>Kết quả tìm kiếm cho từ khoá  <span>"<?= $_GET['search'] ?>"</span></p>
                        ...
                        <?php
                            ...
                            <div class="result__message">
                                ...
                                <p>Chúng tôi không tìm thấy sản phẩm  <span>"<?= $_GET['search'] ?>"</span> nào. Bên dưới là kết quả gợi ý thay thế.</p>               
                            </div>
                        <?php
                                }
                            }
                    ...
                    <div class="product">
                        <div class="row sm-gutter">
                            ...
                            <div class="col elg-2-4 lg-3 md-3 sm-4 exsm-6">
                                <a href="./ProductDetail/<?= $value['productId']; ?><?php if (isset($_GET['search'])) {
                                            echo('?search=' . $_GET['search']);
                                        } ?>" class="product__item margin-top10">
                                    <div class="product-item__img" style="background-image: url('<?= $value['imageUrl']; ?>');"></div>
                                    <div class="product-item__content">
                                        <h4 class="product-item__name"><?= $value['productName']; ?></h4>
                                        ...
                                        echo viPrice($discountPrice, 'VND'); ?>
                                            </span>
                                        </div>
                                        <div class="product-item__react">
                                            <div class="product-item__rating">
                                                <?php
                                                    displayStar($value['productRating']); ?>
                                            </div>
                                            <span class="product-item__sold">
                                                <span class="sold-number"><?= $value['productSold']; ?></span>
                                                đã bán
                                            </span>
                                        </div>
                                        <div class="product-item__origin">
                                            <span class="item-brand"><?= $value['productBrand']; ?></span>
                                            <span class="item-source"><?= $value['productSource']; ?></span>
                                        </div>
                                        <!-- Item label -->
                                        ...
                                        <div class="product-item__discount">
                                            <span class="percent"><?= $value['productDiscount']*100; ?>%</span>
                    ...
                    <?php
                        require_once '../src/views/block/Pagination.php'
                    ?>
                </div>
            </div>
        </div>
