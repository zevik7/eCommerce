<div class="filter">
    ...
    echo "active";
        ...
        <li class="filter__item 
        <?php if (isset($_GET['filter']) && $_GET['filter'] == 'newest') {
    echo "active";
}?>">
            <a class="" 
        ...
        <li class="filter__item
        <?php if (isset($_GET['filter']) && $_GET['filter'] == 'selling') {
    echo "active";
}?>">
            <a class="" 
        ...
        <li class="filter__item filter__item-select">
            <div class="select
            <?php if (isset($_GET['filter']) && preg_match('/price-desc|price-asc/', $_GET['filter'])) {
    echo "active";
}?>
            ">
